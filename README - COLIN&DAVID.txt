...
NOTE:
Copy the krackattack folder form the blackboard uplaod the directory this read me is in, then you can compile hostapd

DIPENDANCIES:
This script must be run in Kali Linux, ensure that all the dependancies are installed (run apt-get update and pip update first):
...
To compile hostapd, open a terminal in the hostapd directory (cd ../hostapd):
